...
const hi: Dict = {
  ...
  cta: {
    ...
    champion: "Champion के रूप में जुड़ें",
  },
  hero: {
    kickerA: "Ecosystem commerce",
    ...
    photoAlt:
      "एक Well-being Champion शाम की गर्म रोशनी में एक ग्रामीण परिवार को घर के दरवाज़े पर टैबलेट दिखाती हुई।",
    signals: [
  ...
  how: {
    ...
    photoAlt:
      "एक महिला Well-being Champion ग्रामीण भारत में एक परिवार को उनके घर पर टैबलेट पर सेवा समझाती हुई।",
    steps: [
      { n: "01", title: "एक भरोसेमंद स्थानीय व्यक्ति जुड़ता है", body: "वे Well-being Champion बनते हैं — ज़्यादातर महिलाएँ, जिन्हें पड़ोसी पहले से जानते और भरोसा करते हैं।" },
      ...
      { n: "04", title: "सबको लाभ होता है", body: "परिवारों को वह पहुँच मिलती है जो पहले कभी नहीं थी, Champions को सच्ची आजीविका मिलती है, और साझेदार अंततः अंतिम छोर तक पहुँचते हैं।" },
    ],
  },
  gap: {
    kicker: "अवसर",
  ...
  platform: {
    ...
    principles: ["Asset-light", "समुदाय-प्रथम", "उद्देश्य-प्रेरित", "राजस्व-समर्थित", "Scalable"],
    layers: [
      ...
      { label: "नेटवर्क — Well-being Champions", items: "Gig · Knowledge · Entrepreneurial", note: "समुदायों में बसे सत्यापनकर्ता और लेन-देन उत्प्रेरक।" },
      { label: "समुदाय विश्वास परत", items: "Heartfulness · ASHA · सहकारी · महासंघ", note: "एक बाज़ार-आधारित संपत्ति: सहज उपलब्ध, उच्च चक्रवृद्धि मूल्य।" },
    ],
    heart: "इसका हृदय",
  },
  verticals: {
    ...
    items: [
      ...
      { title: "ONDC के ज़रिए मार्केटप्लेस", body: "ओपन नेटवर्क पर सामुदायिक समूह-खरीद — Pinduoduo मॉडल से प्रेरित, बेहतर मूल्य और संयुक्त लॉजिस्टिक्स।" },
    ],
  },
  network: {
    kicker: "नेटवर्क",
    h: "वह इंजन जो सब कुछ",
    hEm: "चलाता है।",
    lead: "Well-being Champions हर समुदाय में बसे सत्यापनकर्ता और उत्प्रेरक हैं — ज़्यादातर महिलाएँ, जिन पर पड़ोसी पहले से भरोसा करते हैं। एक प्रशिक्षित Champion 200–500 परिवारों की सेवा कर सकती है, और एक स्पष्ट सीढ़ी पर आगे बढ़ती है।",
    photoAlt:
      "अलग-अलग उम्र की पाँच महिला Well-being Champions सुनहरी रोशनी में एक गाँव की गली में एक साथ खड़ी हैं।",
    personas: [
      { title: "Gig Champion", earns: "कार्य-आधारित", body: "ऐप-आधारित कार्य — डिलीवरी, सर्वे, रेफ़रल, डेटा संग्रह, दस्तावेज़ सत्यापन।" },
      { title: "Knowledge Champion", earns: "₹20,000–30,000 / माह", body: "उपभोक्ता शिक्षा, श्रेणी-दक्षता और समुदाय में भरोसा — वित्तीय-साक्षरता व जागरूकता कार्यक्रम।" },
      { title: "Entrepreneurial Champion", earns: "₹1 लाख / माह तक", body: "माइक्रो-डिस्ट्रिब्यूशन, मार्गदर्शन और प्लेटफ़ॉर्म पर अपना व्यवसाय।" },
    ],
    recruitedLabel: "उन नेटवर्कों से, जिन पर भारत पहले से भरोसा करता है",
    recruitedFrom: [
      "Heartfulness नेटवर्क",
      "ASHA कार्यकर्ता",
      "Anganwadi कार्यकर्ता",
  ...
  livelihoods: {
    ...
    streams: [
      ...
      { title: "वाणिज्य व माइक्रो-डिस्ट्रिब्यूशन", figure: "₹8–15k", note: "FMCG + स्थानीय श्रेणी" },
  ...
  architecture: {
    ...
    rails: [
      { title: "भारत की डिजिटल पब्लिक इन्फ़्रास्ट्रक्चर", body: "Aadhaar, UPI और DigiLocker के साथ एकीकरण के लिए डिज़ाइन — वही रेल जिन पर देश पहले से चलता है।", tags: ["Aadhaar", "UPI", "DigiLocker"] },
      { title: "ओपन नेटवर्क", body: "ओपन कॉमर्स के लिए ONDC और सहमति-आधारित वित्तीय डेटा के लिए Account Aggregator ढाँचा।", tags: ["ONDC", "Account Aggregator"] },
      { title: "डिज़ाइन से अनुपालन", body: "नियामक नियम विन्यास-योग्य नीति के रूप में अंतर्निहित — पहले दिन से सहमति-प्रबंधन के साथ।", tags: ["RBI · SEBI · IRDA · GST", "DPDP"] },
      { title: "एक विश्वास परत", body: "छेड़-स्पष्ट रिकॉर्ड, अंत-से-अंत ट्रेसबिलिटी और ऑडिट ट्रेल के लिए permissioned-blockchain डिज़ाइन।", tags: ["Permissioned ledger", "Audit trails"] },
      { title: "सहायता-युक्त व स्थानीय भाषा", body: "ऐप-साक्षरता की ज़रूरत नहीं — स्थानीय भाषाओं में सहायता-युक्त प्रक्रिया, ग्रामीण बाज़ारों के लिए छोटे-टिकट प्रवाह।", tags: ["कम-साक्षरता", "₹100–500 SIPs"] },
      { title: "AI + मानवीय भरोसा", body: "तकनीक पीछे का काम संभालती है; भरोसेमंद इंसान सामने का रिश्ता। दोनों, कोई एक नहीं।", tags: ["AI back end", "Human front end"] },
    ],
  },
  flywheel: {
    ...
    hEm: "रचना से।",
    lead: "Reed's Law के अनुसार, समूह-निर्माण नेटवर्क का मूल्य 2ⁿ की दर से बढ़ता है। जैसे-जैसे Champions मंडल और सामूहिक समूह बनाती हैं, घनत्व और समुदाय-बंधन एक ऐसी खाई बन जाते हैं जिसे कोई उत्पाद-फ़ीचर दोहरा नहीं सकता।",
    groups: ["म्यूचुअल-फंड SIP मंडल", "बीमा खरीद समूह", "ONDC खरीद समूह"],
    loop: [
      "अधिक Champions जुड़ती हैं",
  ...
  whynow: {
    ...
    tailwinds: [
      ...
      { k: "ONDC", t: "ओपन नेटवर्क फ़ॉर डिजिटल कॉमर्स", d: "अवसंरचना जो अंततः इकोसिस्टम-मॉडल को संभव बनाती है।" },
      { k: "AA", t: "Account Aggregator", d: "सहमति-आधारित वित्तीय डेटा से ऋण व बीमा संभव।" },
      { k: "ESG", t: "प्रभाव-पूँजी की रुचि", d: "विस्तार-योग्य, समुदाय-आधारित मॉडलों की निवेशक माँग।" },
      { k: "Post-COVID", t: "आजीविका की मज़बूती", d: "समुदाय-आधारित आय सबसे टिकाऊ साबित हुई।" },
      { k: "Reed's Law", t: "नेटवर्क मूल्य बढ़ता है", d: "हर नए सदस्य के साथ मूल्य बढ़ता है।" },
    ],
  },
  india: {
  ...
  partners: {
    ...
    audiences: [
      { title: "रणनीतिक साझेदार", body: "ब्रांड, fintech व वित्तीय संस्थान, स्वास्थ्य नेटवर्क, बीमाकर्ता, ऊर्जा व लॉजिस्टिक्स — अंतिम छोर खुद बनाए बिना भरोसेमंद गहरी पहुँच पाएँ।" },
      { title: "प्रभाव निवेशक", body: "समुदाय-आधारित विकास और मापनीय परिणामों के अनुरूप धैर्यवान पूँजी — एक asset-light मॉडल जो इकाई-अर्थशास्त्र के लिए नकदी-व्यय पर निर्भर नहीं।" },
  ...
  faq: {
    ...
    items: [
      ...
      { q: "यह gig या डिलीवरी प्लेटफ़ॉर्म से कैसे अलग है?", a: "Gig प्लेटफ़ॉर्म लेन-देन के लिए बनते हैं; हम भरोसे और गहराई के लिए बनाते हैं। एक Champion 200–500 परिवारों के साथ कई सेवाओं में दीर्घकालिक रिश्ता रखती है — रिश्ते की पूँजी, न कि एक-बार की डिलीवरी।" },
      { q: "आप भरोसा, निजता और नियामक अनुपालन कैसे बनाए रखते हैं?", a: "डिज़ाइन से। प्लेटफ़ॉर्म भारत की डिजिटल पब्लिक इन्फ़्रास्ट्रक्चर से जुड़ने के लिए बना है, RBI/SEBI/IRDA/GST नियमों को विन्यास-योग्य नीति के रूप में समाहित करता है, सहमति-प्रबंधन के साथ DPDP-अनुरूप है, और ऑडिट ट्रेल व vKYC जाँच वाली permissioned-blockchain विश्वास परत का उपयोग करता है।" },
      { q: "बिना इन्वेंट्री या कर्मचारियों के आप पैमाना कैसे बढ़ाते हैं?", a: "एक asset-light, hub-and-spoke मॉडल: एक छोटा केंद्रीय हब, क्षेत्रीय साझेदार जो मौजूदा सामुदायिक नेटवर्क सक्रिय करते हैं, और Champions जो पूँजी नहीं — समय और रिश्ते लगाती हैं। विस्तार से पहले इकाई-अर्थशास्त्र ज़िला-स्तर पर सिद्ध किया जाता है।" },
      { q: "Well-being Champion कौन बनता है — और क्या कोई शुल्क है?", a: "भरोसेमंद स्थानीय लोग — ज़्यादातर महिलाएँ — जो ASHA व Anganwadi कार्यकर्ता, महिला सहकारी, Heartfulness स्वयंसेवक और सेवानिवृत्त सशस्त्र बल जैसे मौजूदा नेटवर्कों से जुड़ती हैं। किसी डिग्री या पूर्व अनुभव की ज़रूरत नहीं। [PLACEHOLDER: शामिल होने की शुल्क-नीति यहाँ बताएँ। TODO: लॉन्च से पहले पुष्टि करें।]" },
      { q: "हमारा संगठन e2E Reach के साथ कैसे साझेदारी कर सकता है?", a: "एक रणनीतिक साझेदार (ब्रांड, fintech, वित्त, स्वास्थ्य, ऊर्जा, लॉजिस्टिक्स), एक प्रभाव निवेशक, या एक इकोसिस्टम सक्षमकर्ता (तकनीक, प्रशिक्षण, सरकारी कार्यक्रम) के रूप में। बातचीत शुरू करने के लिए information@e2ereach.com पर लिखें।" },
    ],
  },
  finalCta: {
    kickerA: "Ecosystem commerce",
